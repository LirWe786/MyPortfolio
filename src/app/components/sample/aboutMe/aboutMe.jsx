        ...
        >
            ...
            <div className={styles.aboutMain} >
                ...
                >
                    ...
                    <StackCard widthImg={{ width: 80 }} txt='JS' >
                        <svg viewBox="0 0 128 128">
                    ...
                    <StackCard widthImg={{ width: 80 }} txt='React' >
                        <svg viewBox="0 0 128 128">
                    ...
                    <StackCard txt='Next JS' >
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" width={80} />
                    </StackCard>

                    <StackCard txt='Zustand' >
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/zustand/zustand-original.svg" width={80} />
                    </StackCard>

                    <StackCard widthImg={{ width: 80 }} txt='MaterialUi' >
                    ...
                    <StackCard widthImg={{ width: 80 }} txt='Tailwind CSS' >
                        <svg viewBox="0 0 128 128">
